          ...
          <CardContent>
            <div className="space-y-4">
              {recentProjects.length === 0 ? (
                <p className="text-neutral-500 text-sm">No recent projects available.</p>
              ) : (
            ...
            <div className="h-48 relative">
              ...
              <div className="absolute bottom-0 left-0 w-full h-full flex items-end justify-around px-4">
                {weeklyActivity.length === 0 ? (
                  <div className="text-neutral-500 text-sm">No activity available.</div>
                ) : (
          ...
          <CardContent>
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {developmentActivity.length === 0 ? (
                <p className="text-neutral-500 text-sm">No activity available.</p>
              ) : (
